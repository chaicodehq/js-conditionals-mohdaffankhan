...
export function getWeatherAdvice(temperature, isRaining) {
  ...
  if (temperature >= 25) return isRaining ? 'Warm but rainy - consider indoor activities' : 'Great weather for hiking - don\'t forget sunscreen';
  if (temperature >= 15) return isRaining ? 'Cool and rainy - bring waterproof gear if hiking' : 'Perfect hiking weather - enjoy the trails';
  if (temperature >= 5) return isRaining ? 'Cold and wet - best to stay indoors' : 'Chilly - wear layers for your hike';
